...
while True:
    ...
    worksheet.write('A1', 'OI', bold)
    worksheet.write('B1', 'CHNG IN OI', bold)
    worksheet.write('C1', 'VOLUME', bold)
    worksheet.write('D1', 'LTP', bold)
    worksheet.write('E1', 'STKP', bold)
    ...
    for oi, cio, vol, ltp, doi, dcoi in tuple_List:
